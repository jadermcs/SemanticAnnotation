          ...
          <section className="hero is-medium is-link">
            <div className="hero-body container">
              <div className="title is-3">
                This is a study on sentiment perception of polysemous words.
              </div>
              <div className="subtitle is-4">
                Inside you'll be asked to rate how the feeling varies for a word 
          ...
          <section className="hero is-medium">
            <div className="hero-body container">
              <p className="subtitle is-4">
                Your answers will be completely anonymous. LIST will not collect your personal data through this questionnaire and will not be able to identify you based on your answers.

                For more information about LIST’s privacy notice please visit our webpage at: <a href="https://www.list.lu/fr/research-participant-privacy-notice/">list.lu</a>
              </p>
